...
- name: AWS Pinpoint API Get Campaigns
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/campaigns/
  tags: Campaign
  properties:
...
- name: AWS Pinpoint API Campaign Instance
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/campaigns/campaign-id
  tags: Campaign
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Campaign Version Instance
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/campaigns/campaign-id/versions/version
...
- name: AWS Pinpoint API Endpoints List
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/endpoints
  tags: Endpoint
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Endpoint Instance
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/endpoints/endpoint-id
  tags: Endpoint
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Import Job List
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/jobs/import
  tags: Import Job
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Import Job List by Segment
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/segments/segment-id/jobs/import
  tags: Import Job
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Import Job Instance
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/jobs/import/{job-id}
  tags: Import Job
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API Get URI
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-pinpoint.jpg
  humanURL: https://aws.amazon.com/pinpoint/
  baseURL: ://///apps/application-id/settings
  tags: URI
  properties:
  - type: x-openapi-spec
...
- name: AWS Pinpoint API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-pinpoint/master/_listings/aws-pinpoint/openapi.md
x-common:
- type: x-blog
